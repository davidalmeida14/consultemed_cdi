                ...
                <table class="table no-margin">
                  ...
                  <tr>
					...
					<c:forEach var="m" items="${medicos}">
						<tr>
							<td>${m.nome == null ? '' : m.nome}</td>
							<td>${m.email == null ? '' : m.email}</td>
							<td>${m.telefone == null ? '' : m.telefone}</td>
							<td>${m.crm == null ? '' : m.crm}</td>
								<td>
	                        		<a href="${pageContext.request.contextPath}/admin/medicos?id=${m.id}&action=editar" class="btn btn-sm btn-primary">Editar</a>
	                        		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <strong>Deseja excluir o medico selecionado ?</strong>
		      </div>
